...
class _BookmarkPageState extends State<BookmarkPage> {
                      ...
                      return Dismissible(
                        ...
                        child: VerseCardWidget(
                            verseDetails: ChapterDetailedModel(
                                verseNumber: verseBookmarkModelList[position]
                                    .verseNumber,
                                chapterNumber: verseBookmarkModelList[position]
                                    .chapterNumber,
                                text: verseBookmarkModelList[position].text,
                                transliteration:
                                    verseBookmarkModelList[position]
                                        .transliteration,
                                wordMeanings: verseBookmarkModelList[position]
                                    .wordMeanings,
                                translation: verseBookmarkModelList[position]
                                    .translation,
                                commentary:
                                    verseBookmarkModelList[position].commentary,
                                verseNumberInt: verseBookmarkModelList[position]
                                    .verseNumberInt)),
                        onDismissed: (_) {
                          removeBookmark(
                              verseBookmarkModelList[position].verseNumber,
                              verseBookmarkModelList[position].chapterNumber);
                        },
                      );
                    }),
              )
  ...
  Future<void> fetchAllBookmarks() async {
    ...
    List<VerseBookmarkModel>? _verseBookmarkModelList =
